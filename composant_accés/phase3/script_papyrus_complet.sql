...
CREATE TABLE `entcom` (
  ...
  PRIMARY KEY (`numcom`),
  KEY `numfou` (`numfou`),
  CONSTRAINT `entcom_ibfk_666` FOREIGN KEY (`numfou`) REFERENCES `fournis` (`numfou`)
);
...
CREATE TABLE `ligcom` (
  ...
  KEY `codart` (`codart`),
  CONSTRAINT `ligcom_ibfk_3` FOREIGN KEY (`numcom`) REFERENCES `entcom` (`numcom`),
  CONSTRAINT `ligcom_ibfk_4` FOREIGN KEY (`codart`) REFERENCES `produit` (`codart`)
);
...
CREATE TABLE `vente` (
  ...
  KEY `numfou` (`numfou`),
  CONSTRAINT `vente_ibfk_3` FOREIGN KEY (`numfou`) REFERENCES `fournis` (`numfou`),
  CONSTRAINT `vente_ibfk_4` FOREIGN KEY (`codart`) REFERENCES `produit` (`codart`)
) ;
